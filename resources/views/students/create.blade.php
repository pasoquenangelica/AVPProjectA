...
<body data-page="students-create">
    <div class="wrap">
        <div class="card">
            <h1>Add Student</h1>
                ...
                <div class="full">
                    ...
                    <select id="degree_id" name="degree_id" required>
                        ...
                        @foreach($degrees as $degree)
                            <option value="{{ $degree->id }}" @selected(old('degree_id') == $degree->id)>{{ $degree->degree_title }}</option>
                        @endforeach
                    </select>
