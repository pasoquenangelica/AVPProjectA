    ...
    <div class="container">
        <div class="card">
            ...
            <form method="POST" action="{{ route('degree.store') }}">
                ...
                <input id="degree_title" type="text" name="degree_title" value="{{ old('degree_title') }}" required>

                <div class="actions">
                    <button class="button" type="submit">Save Degree</button>
